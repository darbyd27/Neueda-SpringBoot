...
import uk.ac.belfastmet.titanic.service.PassengerRestServiceImpl;

@RestController
@RequestMapping("/api/passenger")


public class PasengerRestController
{
	@Autowired
	PassengerRestServiceImpl passengerRestService;
	
	

	public PasengerRestController(PassengerRestServiceImpl passengerRestService) {
		super();
